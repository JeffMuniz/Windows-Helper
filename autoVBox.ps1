...
# create storage
.\VBoxManage createhd --filename E:\VM\$name.vdi --size $disksize --format VDI
#.\VBoxManage createhd --filename E:\VM\io.vdi --size $OS_SIZE --format VDI
...
.\VBoxManage unattended install "$name" --iso="E:\Downloads\Parrot-kde-security-4.7_x64.iso" 
--user=someuser --password=some pass --full-user-name="Tips For IT Pros" --time-zone=UTC --hostname=$name.lab.local
